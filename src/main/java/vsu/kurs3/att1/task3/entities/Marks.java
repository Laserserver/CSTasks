...
public class Marks {
    ...
    public Boolean getMarkOne() {
        return markOne;
    }

    @Column(name = "MarkSecond", nullable = false)
    public Boolean getMarkTwo() {
        return markTwo;
    }

    @Column(name = "MarkThird", nullable = false)
    public Boolean getMarkThree() {
        return markThree;
    }
    ...
    public void setMarkOne(Boolean markOne) {
        this.markOne = markOne;
    }

    public void setMarkTwo(Boolean markTwo) {
        this.markTwo = markTwo;
    }

    public void setMarkThree(Boolean markThree) {
